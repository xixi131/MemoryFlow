...
## 2026-04-27 - Main-log rollover for the Phase 5 reducer-foundation slice

- Reason for rollover:
  - `codex-progress.md` grew past the default startup byte threshold during the Phase 5 reducer-foundation and late Phase 4 handoff slice.
  - The default startup path only needs the current summary plus the newest five reducer-behavior records before the next pending gesture-lock task.
