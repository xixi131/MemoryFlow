...
| --- | --- | --- |
| Logged-out compact | `mode='app'`, `isLoggedIn=false`, and not expanded. The compact shell uses the shared base width (`160`) and renders an empty quiet shell with no login entry; a tap does nothing. Browser login moves to the tray/settings surface (`win-advanced-capability-lifecycle`). Synced to macOS Phase 7 basic mode on 2026-07-17. | [DynamicIslandWidget.tsx:1170](../front-end/src/components/DynamicIslandWidget.tsx#L1170), [DynamicIslandWidget.tsx:1486](../front-end/src/components/DynamicIslandWidget.tsx#L1486), [DynamicIslandWidget.tsx:2121](../front-end/src/components/DynamicIslandWidget.tsx#L2121) |
...
| Music activity | A `Playing` or `Paused` music IPC update takes over regardless of login state (login-free basic mode, synced to macOS Phase 7 on 2026-07-17), assigns `musicData`, clears forced compact mode, and selects `mode='music'`. | [DynamicIslandWidget.tsx:683](../front-end/src/components/DynamicIslandWidget.tsx#L683), [DynamicIslandWidget.tsx:684](../front-end/src/components/DynamicIslandWidget.tsx#L684) |
...
| Music stopped | A `Stopped` update immediately returns the widget to app mode and clears music data, restoring the applicable app compact/activity state. While logged out, an expanded music card also collapses on exit (paused timeout or stop), because the logged-out app mode has no expandable content. | [DynamicIslandWidget.tsx:712](../front-end/src/components/DynamicIslandWidget.tsx#L712), [DynamicIslandWidget.tsx:715](../front-end/src/components/DynamicIslandWidget.tsx#L715) |
