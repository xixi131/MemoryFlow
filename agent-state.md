...
## First pending task
* Detect whether the target display needs notch-aware placement.
...
5. Read `mac-island/MemoryFlowIsland/Window/ScreenMetrics.swift`, `NotchLayoutEngine.swift`, `DisplayObserver.swift`, and `IslandWindowController.swift`.
