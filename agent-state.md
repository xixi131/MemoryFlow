...
## First pending task
* Show the island on the correct display using the new placement result.
...
5. Read `mac-island/MemoryFlowIsland/Window/ScreenMetrics.swift`, `DisplayObserver.swift`, `NotchLayoutEngine.swift`, and `IslandWindowController.swift`.
